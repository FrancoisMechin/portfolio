...
return (
        ...
        {formSubmitted && (     
            <div ref={alertSuccessRef} className="fixed flex w-96 shadow-lg rounded-lg z-50 top-24 right-10" role='alert'>
                ...
                <div className="px-4 py-6 bg-white rounded-r-lg flex justify-between items-center w-full border border-l-transparent border-gray-200">
                    <div>Votre mail a bien été envoyé !</div>
                <div>
        ...
        {isWarningAlert && (     
            <div ref={alertWarningRef} class="fixed flex w-[50vh] shadow-lg rounded-lg z-50 top-24 right-10" role='alert'>
                ...
                <div>Nous avons rencontré un problème, réessayez ultérieurement</div>
