...
const Navbar = ({ locales }) => {
	...
	return (
		...
		<div
			...
			className={
				shadow
					? "fixed w-full h-20 shadow-xl bg-[#ecf0f3]/80 z-50"
					: "fixed w-full h-20 bg-[#ecf0f3]/80 z-50"
			}
		>
			<div className="flex justify-between items-center w-full h-full px-2 2xl:px-2">
				...
				<div className="md:absolute md:ml-[10rem] justify-between mr-20">
						...
						<div>
							...
							<div className="border-b border-gray-300 mb-4">
								<p className="w-[85%] md:w-[90%] py-4">
									<FormattedMessage id="navbar.mobile.slogan" />
								</p>
							</div>
						</div>
						...
						<div className="py-4 flex flex-col">
							...
							<div className="pt-40">
								<p className="uppercase tracking-widest text-[#5651e5]">
									<FormattedMessage id="navbar.mobile.redirects" />
								</p>
								<div className="flex items-center justify-between my-4 w-full sm:w-[80%]">
									{/* //? Utilisé deux fois, composants à créer? */}
									<a
										href="mailto:f.mechin@protonmail.com"
										target="__blank"
									>
									...
									<a
										href="https://www.linkedin.com/in/francois-mechin/"
										target="__blank"
									>
										<div className="rounded-full shadow-lg shadow-gray-400 p-5 cursor-pointer hover:scale-110 ease-in duration-300">
											<FaLinkedinIn />
									...
									<a
										href="https://github.com/FrancoisMechin"
										target="__blank"
									>
										<div className="rounded-full shadow-lg shadow-gray-400 p-5 cursor-pointer hover:scale-110 ease-in duration-300">
											<FaGithub />
